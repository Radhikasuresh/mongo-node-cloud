...
export const studentValiationSchema = yup.object({
  ...
  qualification:yup.string().required("It is not bad to tell your qualification")
})
...
function AddStudents({students, setStudents}) {
  ...
  return (
    ...
    <div className='form-group'>
        ...
        <TextField  label="qualification" variant="outlined" fullWidth sx={{ m: 1 }} 
         placeholder='Enter qualification of student'
         type="text"
